...
The account confirmation callback is a mandatory native UI integration seam. No current enabled screen calls it, and a callback that approves without showing the selected account does not satisfy the live acceptance gate.
