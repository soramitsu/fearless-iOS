...
final class AccountCreationHelper {
    ...
    static func createMetaAccountFromMnemonic(_ mnemonicString: String? = nil,
                                              cryptoType: MultiassetCryptoType,
                                              name: String = "fearless",
                                              networkType: Chain = .westend, // TODO: get rid of
                                              derivationPath: String = "",
                                              keychain: KeystoreProtocol,
    ...
    static func createMetaAccountFromSeed(_ seed: String,
                                      cryptoType: MultiassetCryptoType,
                                      name: String = "fearless",
                                      networkType: Chain = .westend, // TODO: get rid of
                                      derivationPath: String = "",
                                      keychain: KeystoreProtocol,
                                      settings: SelectedWalletSettings) throws {
        let request = ChainAccountImportSeedRequest(seed: seed,
                                                    username: name,
                                                    networkType: networkType,
                                                    derivationPath: derivationPath,
                                                    cryptoType: cryptoType)
    ...
    static func createMetaAccountFromKeystore(_ filename: String,
                                          password: String,
                                          keychain: KeystoreProtocol,
                                          settings: SelectedWalletSettings) throws {
        guard let url = Bundle(for: AccountCreationHelper.self).url(forResource: filename, withExtension: "json") else {
        ...
        return try createMetaAccountFromKeystoreData(data,
                                                     password: password,
                                                     keychain: keychain,
                                                     settings: settings,
                                                     networkType: info.networkType ?? .westend,
    ...
    static func createMetaAccountFromKeystoreData(_ data: Data,
                                              password: String,
                                              keychain: KeystoreProtocol,
        ...
        let request = ChainAccountImportKeystoreRequest(keystore: keystoreString,
                                                        password: password,
                                                        username: username,
                                                        networkType: networkType,
                                                        cryptoType: cryptoType)
