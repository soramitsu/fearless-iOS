...
class MockChainRegistryProtocol: fearless.ChainRegistryProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    var availableChainIds: Set<SSFModels.ChainModel.Id>? {
        get {
            return cuckoo_manager.getter(
                "availableChainIds",
                superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    var availableChains: [SSFModels.ChainModel] {
        get {
            return cuckoo_manager.getter(
                "availableChains",
                superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func resetConnection(for p0: SSFModels.ChainModel.Id) {
        return cuckoo_manager.call(
            "resetConnection(for p0: SSFModels.ChainModel.Id)",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func retryConnection(for p0: SSFModels.ChainModel.Id) {
        return cuckoo_manager.call(
            "retryConnection(for p0: SSFModels.ChainModel.Id)",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func getConnection(for p0: SSFModels.ChainModel.Id) -> fearless.ChainConnection? {
        return cuckoo_manager.call(
            "getConnection(for p0: SSFModels.ChainModel.Id) -> fearless.ChainConnection?",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func getRuntimeProvider(for p0: SSFModels.ChainModel.Id) -> fearless.RuntimeProviderProtocol? {
        return cuckoo_manager.call(
            "getRuntimeProvider(for p0: SSFModels.ChainModel.Id) -> fearless.RuntimeProviderProtocol?",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func getChain(for p0: SSFModels.ChainModel.Id) -> SSFModels.ChainModel? {
        return cuckoo_manager.call(
            "getChain(for p0: SSFModels.ChainModel.Id) -> SSFModels.ChainModel?",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func chainsSubscribe(_ p0: AnyObject, runningInQueue p1: DispatchQueue, updateClosure p2: @escaping ([DataProviderChange<SSFModels.ChainModel>]) -> Void) {
        return cuckoo_manager.call(
            "chainsSubscribe(_ p0: AnyObject, runningInQueue p1: DispatchQueue, updateClosure p2: @escaping ([DataProviderChange<SSFModels.ChainModel>]) -> Void)",
            parameters: (p0, p1, p2),
            escapingParameters: (p0, p1, p2),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func getEthereumConnection(for p0: SSFModels.ChainModel.Id) -> Web3.Eth? {
        return cuckoo_manager.call(
            "getEthereumConnection(for p0: SSFModels.ChainModel.Id) -> Web3.Eth?",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_ChainRegistryProtocol: Cuckoo.StubbingProxy {
        ...
        var availableChainIds: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockChainRegistryProtocol,Set<SSFModels.ChainModel.Id>?> {
            return .init(manager: cuckoo_manager, name: "availableChainIds")
        }
        
        var availableChains: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockChainRegistryProtocol,[SSFModels.ChainModel]> {
        ...
        func resetConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(SSFModels.ChainModel.Id)> where M1.MatchedType == SSFModels.ChainModel.Id {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockChainRegistryProtocol.self,
                method: "resetConnection(for p0: SSFModels.ChainModel.Id)",
                parameterMatchers: matchers
            ))
        }
        
        func retryConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(SSFModels.ChainModel.Id)> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockChainRegistryProtocol.self,
                method: "retryConnection(for p0: SSFModels.ChainModel.Id)",
                parameterMatchers: matchers
            ))
        }
        
        func getConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), fearless.ChainConnection?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockChainRegistryProtocol.self,
                method: "getConnection(for p0: SSFModels.ChainModel.Id) -> fearless.ChainConnection?",
                parameterMatchers: matchers
            ))
        }
        
        func getRuntimeProvider<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), fearless.RuntimeProviderProtocol?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockChainRegistryProtocol.self,
                method: "getRuntimeProvider(for p0: SSFModels.ChainModel.Id) -> fearless.RuntimeProviderProtocol?",
                parameterMatchers: matchers
            ))
        }
        
        func getChain<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), SSFModels.ChainModel?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockChainRegistryProtocol.self,
                method: "getChain(for p0: SSFModels.ChainModel.Id) -> SSFModels.ChainModel?",
                parameterMatchers: matchers
            ))
        }
        
        func chainsSubscribe<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(_ p0: M1, runningInQueue p1: M2, updateClosure p2: M3) -> Cuckoo.ProtocolStubNoReturnFunction<(AnyObject, DispatchQueue,  ([DataProviderChange<SSFModels.ChainModel>]) -> Void)> where M1.MatchedType == AnyObject, M2.MatchedType == DispatchQueue, M3.MatchedType ==  ([DataProviderChange<SSFModels.ChainModel>]) -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(AnyObject, DispatchQueue,  ([DataProviderChange<SSFModels.ChainModel>]) -> Void)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }]
            return .init(stub: cuckoo_manager.createStub(for: MockChainRegistryProtocol.self,
                method: "chainsSubscribe(_ p0: AnyObject, runningInQueue p1: DispatchQueue, updateClosure p2: @escaping ([DataProviderChange<SSFModels.ChainModel>]) -> Void)",
                parameterMatchers: matchers
            ))
        }
        
        func getEthereumConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), Web3.Eth?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockChainRegistryProtocol.self,
    ...
    struct __VerificationProxy_ChainRegistryProtocol: Cuckoo.VerificationProxy {
        ...
        var availableChainIds: Cuckoo.VerifyReadOnlyProperty<Set<SSFModels.ChainModel.Id>?> {
            return .init(manager: cuckoo_manager, name: "availableChainIds", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
        
        var availableChains: Cuckoo.VerifyReadOnlyProperty<[SSFModels.ChainModel]> {
        ...
        @discardableResult
        func resetConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), Void> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "resetConnection(for p0: SSFModels.ChainModel.Id)",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func retryConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), Void> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "retryConnection(for p0: SSFModels.ChainModel.Id)",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func getConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), fearless.ChainConnection?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "getConnection(for p0: SSFModels.ChainModel.Id) -> fearless.ChainConnection?",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func getRuntimeProvider<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), fearless.RuntimeProviderProtocol?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "getRuntimeProvider(for p0: SSFModels.ChainModel.Id) -> fearless.RuntimeProviderProtocol?",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func getChain<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), SSFModels.ChainModel?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "getChain(for p0: SSFModels.ChainModel.Id) -> SSFModels.ChainModel?",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func chainsSubscribe<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(_ p0: M1, runningInQueue p1: M2, updateClosure p2: M3) -> Cuckoo.__DoNotUse<(AnyObject, DispatchQueue,  ([DataProviderChange<SSFModels.ChainModel>]) -> Void), Void> where M1.MatchedType == AnyObject, M2.MatchedType == DispatchQueue, M3.MatchedType ==  ([DataProviderChange<SSFModels.ChainModel>]) -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(AnyObject, DispatchQueue,  ([DataProviderChange<SSFModels.ChainModel>]) -> Void)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }]
            return cuckoo_manager.verify(
                "chainsSubscribe(_ p0: AnyObject, runningInQueue p1: DispatchQueue, updateClosure p2: @escaping ([DataProviderChange<SSFModels.ChainModel>]) -> Void)",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func getEthereumConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), Web3.Eth?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "getEthereumConnection(for p0: SSFModels.ChainModel.Id) -> Web3.Eth?",
                callMatcher: callMatcher,
...
class ChainRegistryProtocolStub:fearless.ChainRegistryProtocol, @unchecked Sendable {
    ...
    var availableChainIds: Set<SSFModels.ChainModel.Id>? {
        get {
            return DefaultValueRegistry.defaultValue(for: (Set<SSFModels.ChainModel.Id>?).self)
        }
    }
    
    var availableChains: [SSFModels.ChainModel] {
        get {
            return DefaultValueRegistry.defaultValue(for: ([SSFModels.ChainModel]).self)
        }
    }
...
class MockConnectionPoolProtocol<T>: fearless.ConnectionPoolProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    class DefaultImplCaller: fearless.ConnectionPoolProtocol, @unchecked Sendable {
        ...
        private let _storage$1$setupConnection: (SSFModels.ChainModel) throws -> T
        func setupConnection(for p0: SSFModels.ChainModel) throws -> T {
            return try _storage$1$setupConnection(p0)
        }

        private let _storage$2$getConnection: (SSFModels.ChainModel.Id) -> T?
        func getConnection(for p0: SSFModels.ChainModel.Id) -> T? {
        ...
        private let _storage$4$resetConnection: (SSFModels.ChainModel.Id) -> Void
        func resetConnection(for p0: SSFModels.ChainModel.Id) {
    ...
    func setupConnection(for p0: SSFModels.ChainModel) throws -> T {
        return try cuckoo_manager.callThrows(
            "setupConnection(for p0: SSFModels.ChainModel) throws -> T",
            parameters: (p0),
            escapingParameters: (p0),
            errorType: Swift.Error.self,
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func getConnection(for p0: SSFModels.ChainModel.Id) -> T? {
        return cuckoo_manager.call(
            "getConnection(for p0: SSFModels.ChainModel.Id) -> T?",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: __defaultImplStub!.getConnection(for: p0)
    ...
    struct __StubbingProxy_ConnectionPoolProtocol: Cuckoo.StubbingProxy {
        ...
        func setupConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubThrowingFunction<(SSFModels.ChainModel), T,Swift.Error> where M1.MatchedType == SSFModels.ChainModel {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockConnectionPoolProtocol.self,
                method: "setupConnection(for p0: SSFModels.ChainModel) throws -> T",
                parameterMatchers: matchers
            ))
        }
        
        func getConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), T?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockConnectionPoolProtocol.self,
                method: "getConnection(for p0: SSFModels.ChainModel.Id) -> T?",
                parameterMatchers: matchers
            ))
        }
    ...
    struct __VerificationProxy_ConnectionPoolProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func setupConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel), T> where M1.MatchedType == SSFModels.ChainModel {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "setupConnection(for p0: SSFModels.ChainModel) throws -> T",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func getConnection<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), T?> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "getConnection(for p0: SSFModels.ChainModel.Id) -> T?",
                callMatcher: callMatcher,
...
class MockConnectionPoolDelegate: ConnectionPoolDelegate, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func webSocketDidChangeState(chainId p0: SSFModels.ChainModel.Id, state p1: WebSocketEngine.State) {
        return cuckoo_manager.call(
            "webSocketDidChangeState(chainId p0: SSFModels.ChainModel.Id, state p1: WebSocketEngine.State)",
            parameters: (p0, p1),
            escapingParameters: (p0, p1),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_ConnectionPoolDelegate: Cuckoo.StubbingProxy {
        ...
        func webSocketDidChangeState<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(chainId p0: M1, state p1: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(SSFModels.ChainModel.Id, WebSocketEngine.State)> where M1.MatchedType == SSFModels.ChainModel.Id, M2.MatchedType == WebSocketEngine.State {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, WebSocketEngine.State)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockConnectionPoolDelegate.self,
                method: "webSocketDidChangeState(chainId p0: SSFModels.ChainModel.Id, state p1: WebSocketEngine.State)",
                parameterMatchers: matchers
            ))
        }
    }
    ...
    struct __VerificationProxy_ConnectionPoolDelegate: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func webSocketDidChangeState<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(chainId p0: M1, state p1: M2) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id, WebSocketEngine.State), Void> where M1.MatchedType == SSFModels.ChainModel.Id, M2.MatchedType == WebSocketEngine.State {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, WebSocketEngine.State)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return cuckoo_manager.verify(
                "webSocketDidChangeState(chainId p0: SSFModels.ChainModel.Id, state p1: WebSocketEngine.State)",
                callMatcher: callMatcher,
...
class MockRuntimeFilesOperationFactoryProtocol: RuntimeFilesOperationFactoryProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func fetchChainTypesOperation(for p0: SSFModels.ChainModel.Id) -> CompoundOperationWrapper<Data?> {
        return cuckoo_manager.call(
            "fetchChainTypesOperation(for p0: SSFModels.ChainModel.Id) -> CompoundOperationWrapper<Data?>",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func saveChainTypesOperation(for p0: SSFModels.ChainModel.Id, data p1: @escaping () throws -> Data) -> CompoundOperationWrapper<Void> {
        return cuckoo_manager.call(
            "saveChainTypesOperation(for p0: SSFModels.ChainModel.Id, data p1: @escaping () throws -> Data) -> CompoundOperationWrapper<Void>",
            parameters: (p0, p1),
            escapingParameters: (p0, p1),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_RuntimeFilesOperationFactoryProtocol: Cuckoo.StubbingProxy {
        ...
        func fetchChainTypesOperation<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), CompoundOperationWrapper<Data?>> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeFilesOperationFactoryProtocol.self,
                method: "fetchChainTypesOperation(for p0: SSFModels.ChainModel.Id) -> CompoundOperationWrapper<Data?>",
                parameterMatchers: matchers
            ))
        }
        ...
        func saveChainTypesOperation<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(for p0: M1, data p1: M2) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id,  () throws -> Data), CompoundOperationWrapper<Void>> where M1.MatchedType == SSFModels.ChainModel.Id, M2.MatchedType ==  () throws -> Data {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id,  () throws -> Data)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeFilesOperationFactoryProtocol.self,
                method: "saveChainTypesOperation(for p0: SSFModels.ChainModel.Id, data p1: @escaping () throws -> Data) -> CompoundOperationWrapper<Void>",
                parameterMatchers: matchers
            ))
        }
    }
    ...
    struct __VerificationProxy_RuntimeFilesOperationFactoryProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func fetchChainTypesOperation<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), CompoundOperationWrapper<Data?>> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "fetchChainTypesOperation(for p0: SSFModels.ChainModel.Id) -> CompoundOperationWrapper<Data?>",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func saveChainTypesOperation<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(for p0: M1, data p1: M2) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id,  () throws -> Data), CompoundOperationWrapper<Void>> where M1.MatchedType == SSFModels.ChainModel.Id, M2.MatchedType ==  () throws -> Data {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id,  () throws -> Data)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return cuckoo_manager.verify(
                "saveChainTypesOperation(for p0: SSFModels.ChainModel.Id, data p1: @escaping () throws -> Data) -> CompoundOperationWrapper<Void>",
                callMatcher: callMatcher,
...
class MockRuntimeProviderFactoryProtocol: RuntimeProviderFactoryProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func createRuntimeProvider(for p0: SSFModels.ChainModel, chainTypes p1: Data?, usedRuntimePaths p2: [String: [String]]) -> fearless.RuntimeProviderProtocol {
        return cuckoo_manager.call(
            "createRuntimeProvider(for p0: SSFModels.ChainModel, chainTypes p1: Data?, usedRuntimePaths p2: [String: [String]]) -> fearless.RuntimeProviderProtocol",
            parameters: (p0, p1, p2),
            escapingParameters: (p0, p1, p2),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func createHotRuntimeProvider(for p0: SSFModels.ChainModel, runtimeItem p1: SSFModels.RuntimeMetadataItem, chainTypes p2: Data, usedRuntimePaths p3: [String: [String]]) -> fearless.RuntimeProviderProtocol {
        return cuckoo_manager.call(
            "createHotRuntimeProvider(for p0: SSFModels.ChainModel, runtimeItem p1: SSFModels.RuntimeMetadataItem, chainTypes p2: Data, usedRuntimePaths p3: [String: [String]]) -> fearless.RuntimeProviderProtocol",
            parameters: (p0, p1, p2, p3),
            escapingParameters: (p0, p1, p2, p3),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_RuntimeProviderFactoryProtocol: Cuckoo.StubbingProxy {
        ...
        func createRuntimeProvider<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.Matchable>(for p0: M1, chainTypes p1: M2, usedRuntimePaths p2: M3) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel, Data?, [String: [String]]), fearless.RuntimeProviderProtocol> where M1.MatchedType == SSFModels.ChainModel, M2.OptionalMatchedType == Data, M3.MatchedType == [String: [String]] {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel, Data?, [String: [String]])>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeProviderFactoryProtocol.self,
                method: "createRuntimeProvider(for p0: SSFModels.ChainModel, chainTypes p1: Data?, usedRuntimePaths p2: [String: [String]]) -> fearless.RuntimeProviderProtocol",
                parameterMatchers: matchers
            ))
        }
        ...
        func createHotRuntimeProvider<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable, M4: Cuckoo.Matchable>(for p0: M1, runtimeItem p1: M2, chainTypes p2: M3, usedRuntimePaths p3: M4) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel, SSFModels.RuntimeMetadataItem, Data, [String: [String]]), fearless.RuntimeProviderProtocol> where M1.MatchedType == SSFModels.ChainModel, M2.MatchedType == SSFModels.RuntimeMetadataItem, M3.MatchedType == Data, M4.MatchedType == [String: [String]] {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeProviderFactoryProtocol.self,
                method: "createHotRuntimeProvider(for p0: SSFModels.ChainModel, runtimeItem p1: SSFModels.RuntimeMetadataItem, chainTypes p2: Data, usedRuntimePaths p3: [String: [String]]) -> fearless.RuntimeProviderProtocol",
                parameterMatchers: matchers
            ))
        }
    }
...
class MockRuntimeProviderPoolProtocol: fearless.RuntimeProviderPoolProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func setupRuntimeProvider(for p0: SSFModels.ChainModel, chainTypes p1: Data?) -> fearless.RuntimeProviderProtocol {
        return cuckoo_manager.call(
            "setupRuntimeProvider(for p0: SSFModels.ChainModel, chainTypes p1: Data?) -> fearless.RuntimeProviderProtocol",
            parameters: (p0, p1),
            escapingParameters: (p0, p1),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func setupHotRuntimeProvider(for p0: SSFModels.ChainModel, runtimeItem p1: SSFModels.RuntimeMetadataItem, chainTypes p2: Data) -> fearless.RuntimeProviderProtocol {
        return cuckoo_manager.call(
            "setupHotRuntimeProvider(for p0: SSFModels.ChainModel, runtimeItem p1: SSFModels.RuntimeMetadataItem, chainTypes p2: Data) -> fearless.RuntimeProviderProtocol",
            parameters: (p0, p1, p2),
            escapingParameters: (p0, p1, p2),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func destroyRuntimeProvider(for p0: SSFModels.ChainModel.Id) {
        return cuckoo_manager.call(
            "destroyRuntimeProvider(for p0: SSFModels.ChainModel.Id)",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_RuntimeProviderPoolProtocol: Cuckoo.StubbingProxy {
        ...
        func setupRuntimeProvider<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable>(for p0: M1, chainTypes p1: M2) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel, Data?), fearless.RuntimeProviderProtocol> where M1.MatchedType == SSFModels.ChainModel, M2.OptionalMatchedType == Data {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel, Data?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeProviderPoolProtocol.self,
                method: "setupRuntimeProvider(for p0: SSFModels.ChainModel, chainTypes p1: Data?) -> fearless.RuntimeProviderProtocol",
                parameterMatchers: matchers
            ))
        }
        
        func setupHotRuntimeProvider<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(for p0: M1, runtimeItem p1: M2, chainTypes p2: M3) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel, SSFModels.RuntimeMetadataItem, Data), fearless.RuntimeProviderProtocol> where M1.MatchedType == SSFModels.ChainModel, M2.MatchedType == SSFModels.RuntimeMetadataItem, M3.MatchedType == Data {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeProviderPoolProtocol.self,
                method: "setupHotRuntimeProvider(for p0: SSFModels.ChainModel, runtimeItem p1: SSFModels.RuntimeMetadataItem, chainTypes p2: Data) -> fearless.RuntimeProviderProtocol",
                parameterMatchers: matchers
            ))
        }
        
        func destroyRuntimeProvider<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(SSFModels.ChainModel.Id)> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeProviderPoolProtocol.self,
                method: "destroyRuntimeProvider(for p0: SSFModels.ChainModel.Id)",
                parameterMatchers: matchers
            ))
        }
    ...
    struct __VerificationProxy_RuntimeProviderPoolProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func setupRuntimeProvider<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable>(for p0: M1, chainTypes p1: M2) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel, Data?), fearless.RuntimeProviderProtocol> where M1.MatchedType == SSFModels.ChainModel, M2.OptionalMatchedType == Data {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel, Data?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return cuckoo_manager.verify(
                "setupRuntimeProvider(for p0: SSFModels.ChainModel, chainTypes p1: Data?) -> fearless.RuntimeProviderProtocol",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func setupHotRuntimeProvider<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(for p0: M1, runtimeItem p1: M2, chainTypes p2: M3) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel, SSFModels.RuntimeMetadataItem, Data), fearless.RuntimeProviderProtocol> where M1.MatchedType == SSFModels.ChainModel, M2.MatchedType == SSFModels.RuntimeMetadataItem, M3.MatchedType == Data {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel, SSFModels.RuntimeMetadataItem, Data)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }]
            return cuckoo_manager.verify(
                "setupHotRuntimeProvider(for p0: SSFModels.ChainModel, runtimeItem p1: SSFModels.RuntimeMetadataItem, chainTypes p2: Data) -> fearless.RuntimeProviderProtocol",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func destroyRuntimeProvider<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), Void> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "destroyRuntimeProvider(for p0: SSFModels.ChainModel.Id)",
                callMatcher: callMatcher,
...
class MockRuntimeSyncServiceProtocol: fearless.RuntimeSyncServiceProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func register(chain p0: SSFModels.ChainModel, with p1: fearless.ChainConnection) {
        return cuckoo_manager.call(
            "register(chain p0: SSFModels.ChainModel, with p1: fearless.ChainConnection)",
            parameters: (p0, p1),
            escapingParameters: (p0, p1),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func unregister(chainId p0: SSFModels.ChainModel.Id) {
        return cuckoo_manager.call(
            "unregister(chainId p0: SSFModels.ChainModel.Id)",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func apply(version p0: fearless.RuntimeVersion, for p1: SSFModels.ChainModel.Id) {
        return cuckoo_manager.call(
            "apply(version p0: fearless.RuntimeVersion, for p1: SSFModels.ChainModel.Id)",
            parameters: (p0, p1),
            escapingParameters: (p0, p1),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func hasChain(with p0: SSFModels.ChainModel.Id) -> Bool {
        return cuckoo_manager.call(
            "hasChain(with p0: SSFModels.ChainModel.Id) -> Bool",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func isChainSyncing(_ p0: SSFModels.ChainModel.Id) -> Bool {
        return cuckoo_manager.call(
            "isChainSyncing(_ p0: SSFModels.ChainModel.Id) -> Bool",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_RuntimeSyncServiceProtocol: Cuckoo.StubbingProxy {
        ...
        func register<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(chain p0: M1, with p1: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(SSFModels.ChainModel, fearless.ChainConnection)> where M1.MatchedType == SSFModels.ChainModel, M2.MatchedType == fearless.ChainConnection {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel, fearless.ChainConnection)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeSyncServiceProtocol.self,
                method: "register(chain p0: SSFModels.ChainModel, with p1: fearless.ChainConnection)",
                parameterMatchers: matchers
            ))
        }
        
        func unregister<M1: Cuckoo.Matchable>(chainId p0: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(SSFModels.ChainModel.Id)> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeSyncServiceProtocol.self,
                method: "unregister(chainId p0: SSFModels.ChainModel.Id)",
                parameterMatchers: matchers
            ))
        }
        
        func apply<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(version p0: M1, for p1: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(fearless.RuntimeVersion, SSFModels.ChainModel.Id)> where M1.MatchedType == fearless.RuntimeVersion, M2.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(fearless.RuntimeVersion, SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeSyncServiceProtocol.self,
                method: "apply(version p0: fearless.RuntimeVersion, for p1: SSFModels.ChainModel.Id)",
                parameterMatchers: matchers
            ))
        }
        
        func hasChain<M1: Cuckoo.Matchable>(with p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), Bool> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeSyncServiceProtocol.self,
                method: "hasChain(with p0: SSFModels.ChainModel.Id) -> Bool",
                parameterMatchers: matchers
            ))
        }
        
        func isChainSyncing<M1: Cuckoo.Matchable>(_ p0: M1) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id), Bool> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockRuntimeSyncServiceProtocol.self,
                method: "isChainSyncing(_ p0: SSFModels.ChainModel.Id) -> Bool",
                parameterMatchers: matchers
            ))
        }
    }
    ...
    struct __VerificationProxy_RuntimeSyncServiceProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func register<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(chain p0: M1, with p1: M2) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel, fearless.ChainConnection), Void> where M1.MatchedType == SSFModels.ChainModel, M2.MatchedType == fearless.ChainConnection {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel, fearless.ChainConnection)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return cuckoo_manager.verify(
                "register(chain p0: SSFModels.ChainModel, with p1: fearless.ChainConnection)",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func unregister<M1: Cuckoo.Matchable>(chainId p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), Void> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "unregister(chainId p0: SSFModels.ChainModel.Id)",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func apply<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(version p0: M1, for p1: M2) -> Cuckoo.__DoNotUse<(fearless.RuntimeVersion, SSFModels.ChainModel.Id), Void> where M1.MatchedType == fearless.RuntimeVersion, M2.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(fearless.RuntimeVersion, SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return cuckoo_manager.verify(
                "apply(version p0: fearless.RuntimeVersion, for p1: SSFModels.ChainModel.Id)",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func hasChain<M1: Cuckoo.Matchable>(with p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), Bool> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "hasChain(with p0: SSFModels.ChainModel.Id) -> Bool",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func isChainSyncing<M1: Cuckoo.Matchable>(_ p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id), Bool> where M1.MatchedType == SSFModels.ChainModel.Id {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "isChainSyncing(_ p0: SSFModels.ChainModel.Id) -> Bool",
                callMatcher: callMatcher,
...
class MockSpecVersionSubscriptionFactoryProtocol: SpecVersionSubscriptionFactoryProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func createSubscription(for p0: SSFModels.ChainModel.Id, connection p1: JSONRPCEngine) -> SpecVersionSubscriptionProtocol {
        return cuckoo_manager.call(
            "createSubscription(for p0: SSFModels.ChainModel.Id, connection p1: JSONRPCEngine) -> SpecVersionSubscriptionProtocol",
            parameters: (p0, p1),
            escapingParameters: (p0, p1),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_SpecVersionSubscriptionFactoryProtocol: Cuckoo.StubbingProxy {
        ...
        func createSubscription<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(for p0: M1, connection p1: M2) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id, JSONRPCEngine), SpecVersionSubscriptionProtocol> where M1.MatchedType == SSFModels.ChainModel.Id, M2.MatchedType == JSONRPCEngine {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, JSONRPCEngine)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockSpecVersionSubscriptionFactoryProtocol.self,
                method: "createSubscription(for p0: SSFModels.ChainModel.Id, connection p1: JSONRPCEngine) -> SpecVersionSubscriptionProtocol",
                parameterMatchers: matchers
            ))
        }
    }
    ...
    struct __VerificationProxy_SpecVersionSubscriptionFactoryProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func createSubscription<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(for p0: M1, connection p1: M2) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id, JSONRPCEngine), SpecVersionSubscriptionProtocol> where M1.MatchedType == SSFModels.ChainModel.Id, M2.MatchedType == JSONRPCEngine {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, JSONRPCEngine)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }]
            return cuckoo_manager.verify(
                "createSubscription(for p0: SSFModels.ChainModel.Id, connection p1: JSONRPCEngine) -> SpecVersionSubscriptionProtocol",
                callMatcher: callMatcher,
...
class MockCrowdloanRemoteSubscriptionServiceProtocol: CrowdloanRemoteSubscriptionServiceProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func attach(for p0: SSFModels.ChainModel.Id, runningCompletionIn p1: DispatchQueue?, completion p2: RemoteSubscriptionClosure?) -> UUID? {
        return cuckoo_manager.call(
            "attach(for p0: SSFModels.ChainModel.Id, runningCompletionIn p1: DispatchQueue?, completion p2: RemoteSubscriptionClosure?) -> UUID?",
            parameters: (p0, p1, p2),
            escapingParameters: (p0, p1, p2),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func detach(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, runningCompletionIn p2: DispatchQueue?, completion p3: RemoteSubscriptionClosure?) {
        return cuckoo_manager.call(
            "detach(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, runningCompletionIn p2: DispatchQueue?, completion p3: RemoteSubscriptionClosure?)",
            parameters: (p0, p1, p2, p3),
            escapingParameters: (p0, p1, p2, p3),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_CrowdloanRemoteSubscriptionServiceProtocol: Cuckoo.StubbingProxy {
        ...
        func attach<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.OptionalMatchable>(for p0: M1, runningCompletionIn p1: M2, completion p2: M3) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?), UUID?> where M1.MatchedType == SSFModels.ChainModel.Id, M2.OptionalMatchedType == DispatchQueue, M3.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }]
            return .init(stub: cuckoo_manager.createStub(for: MockCrowdloanRemoteSubscriptionServiceProtocol.self,
                method: "attach(for p0: SSFModels.ChainModel.Id, runningCompletionIn p1: DispatchQueue?, completion p2: RemoteSubscriptionClosure?) -> UUID?",
                parameterMatchers: matchers
            ))
        }
        
        func detach<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(for p0: M1, chainId p1: M2, runningCompletionIn p2: M3, completion p3: M4) -> Cuckoo.ProtocolStubNoReturnFunction<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)> where M1.MatchedType == UUID, M2.MatchedType == SSFModels.ChainModel.Id, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockCrowdloanRemoteSubscriptionServiceProtocol.self,
                method: "detach(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, runningCompletionIn p2: DispatchQueue?, completion p3: RemoteSubscriptionClosure?)",
                parameterMatchers: matchers
            ))
        }
    }
    ...
    struct __VerificationProxy_CrowdloanRemoteSubscriptionServiceProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func attach<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.OptionalMatchable>(for p0: M1, runningCompletionIn p1: M2, completion p2: M3) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?), UUID?> where M1.MatchedType == SSFModels.ChainModel.Id, M2.OptionalMatchedType == DispatchQueue, M3.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }]
            return cuckoo_manager.verify(
                "attach(for p0: SSFModels.ChainModel.Id, runningCompletionIn p1: DispatchQueue?, completion p2: RemoteSubscriptionClosure?) -> UUID?",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func detach<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(for p0: M1, chainId p1: M2, runningCompletionIn p2: M3, completion p3: M4) -> Cuckoo.__DoNotUse<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?), Void> where M1.MatchedType == UUID, M2.MatchedType == SSFModels.ChainModel.Id, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
            return cuckoo_manager.verify(
                "detach(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, runningCompletionIn p2: DispatchQueue?, completion p3: RemoteSubscriptionClosure?)",
                callMatcher: callMatcher,
...
class MockCrowdloanRemoteSubscriptionService: CrowdloanRemoteSubscriptionService, Cuckoo.ClassMock, @unchecked Sendable {
    ...
    override func attach(for p0: SSFModels.ChainModel.Id, runningCompletionIn p1: DispatchQueue?, completion p2: RemoteSubscriptionClosure?) -> UUID? {
        return cuckoo_manager.call(
            "attach(for p0: SSFModels.ChainModel.Id, runningCompletionIn p1: DispatchQueue?, completion p2: RemoteSubscriptionClosure?) -> UUID?",
            parameters: (p0, p1, p2),
            escapingParameters: (p0, p1, p2),
    ...
    override func detach(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, runningCompletionIn p2: DispatchQueue?, completion p3: RemoteSubscriptionClosure?) {
        return cuckoo_manager.call(
            "detach(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, runningCompletionIn p2: DispatchQueue?, completion p3: RemoteSubscriptionClosure?)",
            parameters: (p0, p1, p2, p3),
            escapingParameters: (p0, p1, p2, p3),
    ...
    struct __StubbingProxy_CrowdloanRemoteSubscriptionService: Cuckoo.StubbingProxy {
        ...
        func attach<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.OptionalMatchable>(for p0: M1, runningCompletionIn p1: M2, completion p2: M3) -> Cuckoo.ClassStubFunction<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?), UUID?> where M1.MatchedType == SSFModels.ChainModel.Id, M2.OptionalMatchedType == DispatchQueue, M3.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }]
        ...
        func detach<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(for p0: M1, chainId p1: M2, runningCompletionIn p2: M3, completion p3: M4) -> Cuckoo.ClassStubNoReturnFunction<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)> where M1.MatchedType == UUID, M2.MatchedType == SSFModels.ChainModel.Id, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockCrowdloanRemoteSubscriptionService.self,
                method: "detach(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, runningCompletionIn p2: DispatchQueue?, completion p3: RemoteSubscriptionClosure?)",
                parameterMatchers: matchers
...
class MockStakingRemoteSubscriptionServiceProtocol: StakingRemoteSubscriptionServiceProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func attachToGlobalData(for p0: SSFModels.ChainModel.Id, queue p1: DispatchQueue?, closure p2: RemoteSubscriptionClosure?, stakingType p3: StakingType?) -> UUID? {
        return cuckoo_manager.call(
            "attachToGlobalData(for p0: SSFModels.ChainModel.Id, queue p1: DispatchQueue?, closure p2: RemoteSubscriptionClosure?, stakingType p3: StakingType?) -> UUID?",
            parameters: (p0, p1, p2, p3),
            escapingParameters: (p0, p1, p2, p3),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func detachFromGlobalData(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?, stakingType p4: StakingType?) {
        return cuckoo_manager.call(
            "detachFromGlobalData(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?, stakingType p4: StakingType?)",
    ...
    struct __StubbingProxy_StakingRemoteSubscriptionServiceProtocol: Cuckoo.StubbingProxy {
        ...
        func attachToGlobalData<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(for p0: M1, queue p1: M2, closure p2: M3, stakingType p3: M4) -> Cuckoo.ProtocolStubFunction<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?, StakingType?), UUID?> where M1.MatchedType == SSFModels.ChainModel.Id, M2.OptionalMatchedType == DispatchQueue, M3.OptionalMatchedType == RemoteSubscriptionClosure, M4.OptionalMatchedType == StakingType {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?, StakingType?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockStakingRemoteSubscriptionServiceProtocol.self,
                method: "attachToGlobalData(for p0: SSFModels.ChainModel.Id, queue p1: DispatchQueue?, closure p2: RemoteSubscriptionClosure?, stakingType p3: StakingType?) -> UUID?",
                parameterMatchers: matchers
            ))
        }
        
        func detachFromGlobalData<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable, M5: Cuckoo.OptionalMatchable>(for p0: M1, chainId p1: M2, queue p2: M3, closure p3: M4, stakingType p4: M5) -> Cuckoo.ProtocolStubNoReturnFunction<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?, StakingType?)> where M1.MatchedType == UUID, M2.MatchedType == SSFModels.ChainModel.Id, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure, M5.OptionalMatchedType == StakingType {
            let matchers: [Cuckoo.ParameterMatcher<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?, StakingType?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }, wrap(matchable: p4) { $0.4 }]
            return .init(stub: cuckoo_manager.createStub(for: MockStakingRemoteSubscriptionServiceProtocol.self,
                method: "detachFromGlobalData(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?, stakingType p4: StakingType?)",
                parameterMatchers: matchers
            ))
        }
    }
    ...
    struct __VerificationProxy_StakingRemoteSubscriptionServiceProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func detachFromGlobalData<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable, M5: Cuckoo.OptionalMatchable>(for p0: M1, chainId p1: M2, queue p2: M3, closure p3: M4, stakingType p4: M5) -> Cuckoo.__DoNotUse<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?, StakingType?), Void> where M1.MatchedType == UUID, M2.MatchedType == SSFModels.ChainModel.Id, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure, M5.OptionalMatchedType == StakingType {
            let matchers: [Cuckoo.ParameterMatcher<(UUID, SSFModels.ChainModel.Id, DispatchQueue?, RemoteSubscriptionClosure?, StakingType?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }, wrap(matchable: p4) { $0.4 }]
            return cuckoo_manager.verify(
                "detachFromGlobalData(for p0: UUID, chainId p1: SSFModels.ChainModel.Id, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?, stakingType p4: StakingType?)",
                callMatcher: callMatcher,
...
class MockWalletRemoteSubscriptionServiceProtocol: WalletRemoteSubscriptionServiceProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func attachToAccountInfo(of p0: AccountId, chainAsset p1: SSFModels.ChainAsset, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?) async -> String? {
        return await cuckoo_manager.call(
            "attachToAccountInfo(of p0: AccountId, chainAsset p1: SSFModels.ChainAsset, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?) async -> String?",
            parameters: (p0, p1, p2, p3),
            escapingParameters: (p0, p1, p2, p3),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_WalletRemoteSubscriptionServiceProtocol: Cuckoo.StubbingProxy {
        ...
        func attachToAccountInfo<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(of p0: M1, chainAsset p1: M2, queue p2: M3, closure p3: M4) -> Cuckoo.ProtocolStubFunction<(AccountId, SSFModels.ChainAsset, DispatchQueue?, RemoteSubscriptionClosure?), String?> where M1.MatchedType == AccountId, M2.MatchedType == SSFModels.ChainAsset, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(AccountId, SSFModels.ChainAsset, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockWalletRemoteSubscriptionServiceProtocol.self,
                method: "attachToAccountInfo(of p0: AccountId, chainAsset p1: SSFModels.ChainAsset, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?) async -> String?",
                parameterMatchers: matchers
            ))
        }
    ...
    struct __VerificationProxy_WalletRemoteSubscriptionServiceProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func attachToAccountInfo<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(of p0: M1, chainAsset p1: M2, queue p2: M3, closure p3: M4) -> Cuckoo.__DoNotUse<(AccountId, SSFModels.ChainAsset, DispatchQueue?, RemoteSubscriptionClosure?), String?> where M1.MatchedType == AccountId, M2.MatchedType == SSFModels.ChainAsset, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(AccountId, SSFModels.ChainAsset, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
            return cuckoo_manager.verify(
                "attachToAccountInfo(of p0: AccountId, chainAsset p1: SSFModels.ChainAsset, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?) async -> String?",
                callMatcher: callMatcher,
...
class MockWalletRemoteSubscriptionService: WalletRemoteSubscriptionService, Cuckoo.ClassMock, @unchecked Sendable {
    ...
    override func attachToAccountInfo(of p0: AccountId, chainAsset p1: SSFModels.ChainAsset, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?) async -> String? {
        return await cuckoo_manager.call(
            "attachToAccountInfo(of p0: AccountId, chainAsset p1: SSFModels.ChainAsset, queue p2: DispatchQueue?, closure p3: RemoteSubscriptionClosure?) async -> String?",
            parameters: (p0, p1, p2, p3),
            escapingParameters: (p0, p1, p2, p3),
    ...
    struct __StubbingProxy_WalletRemoteSubscriptionService: Cuckoo.StubbingProxy {
        ...
        func attachToAccountInfo<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(of p0: M1, chainAsset p1: M2, queue p2: M3, closure p3: M4) -> Cuckoo.ClassStubFunction<(AccountId, SSFModels.ChainAsset, DispatchQueue?, RemoteSubscriptionClosure?), String?> where M1.MatchedType == AccountId, M2.MatchedType == SSFModels.ChainAsset, M3.OptionalMatchedType == DispatchQueue, M4.OptionalMatchedType == RemoteSubscriptionClosure {
            let matchers: [Cuckoo.ParameterMatcher<(AccountId, SSFModels.ChainAsset, DispatchQueue?, RemoteSubscriptionClosure?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
...
class MockStakingServiceFactoryProtocol: StakingServiceFactoryProtocol, Cuckoo.ProtocolMock, @unchecked Sendable {
    ...
    func createEraValidatorService(for p0: SSFModels.ChainModel) throws -> EraValidatorServiceProtocol {
        return try cuckoo_manager.callThrows(
            "createEraValidatorService(for p0: SSFModels.ChainModel) throws -> EraValidatorServiceProtocol",
            parameters: (p0),
            escapingParameters: (p0),
            errorType: Swift.Error.self,
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    func createRewardCalculatorService(for p0: SSFModels.ChainAsset, assetPrecision p1: Int16, validatorService p2: EraValidatorServiceProtocol, collatorOperationFactory p3: ParachainCollatorOperationFactory?) throws -> RewardCalculatorServiceProtocol {
        return try cuckoo_manager.callThrows(
            "createRewardCalculatorService(for p0: SSFModels.ChainAsset, assetPrecision p1: Int16, validatorService p2: EraValidatorServiceProtocol, collatorOperationFactory p3: ParachainCollatorOperationFactory?) throws -> RewardCalculatorServiceProtocol",
            parameters: (p0, p1, p2, p3),
            escapingParameters: (p0, p1, p2, p3),
            errorType: Swift.Error.self,
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    struct __StubbingProxy_StakingServiceFactoryProtocol: Cuckoo.StubbingProxy {
        ...
        func createEraValidatorService<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.ProtocolStubThrowingFunction<(SSFModels.ChainModel), EraValidatorServiceProtocol,Swift.Error> where M1.MatchedType == SSFModels.ChainModel {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockStakingServiceFactoryProtocol.self,
                method: "createEraValidatorService(for p0: SSFModels.ChainModel) throws -> EraValidatorServiceProtocol",
                parameterMatchers: matchers
            ))
        }
        ...
        func createRewardCalculatorService<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable, M4: Cuckoo.OptionalMatchable>(for p0: M1, assetPrecision p1: M2, validatorService p2: M3, collatorOperationFactory p3: M4) -> Cuckoo.ProtocolStubThrowingFunction<(SSFModels.ChainAsset, Int16, EraValidatorServiceProtocol, ParachainCollatorOperationFactory?), RewardCalculatorServiceProtocol,Swift.Error> where M1.MatchedType == SSFModels.ChainAsset, M2.MatchedType == Int16, M3.MatchedType == EraValidatorServiceProtocol, M4.OptionalMatchedType == ParachainCollatorOperationFactory {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainAsset, Int16, EraValidatorServiceProtocol, ParachainCollatorOperationFactory?)>] = [wrap(matchable: p0) { $0.0 }, wrap(matchable: p1) { $0.1 }, wrap(matchable: p2) { $0.2 }, wrap(matchable: p3) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockStakingServiceFactoryProtocol.self,
                method: "createRewardCalculatorService(for p0: SSFModels.ChainAsset, assetPrecision p1: Int16, validatorService p2: EraValidatorServiceProtocol, collatorOperationFactory p3: ParachainCollatorOperationFactory?) throws -> RewardCalculatorServiceProtocol",
                parameterMatchers: matchers
            ))
        }
    }
    ...
    struct __VerificationProxy_StakingServiceFactoryProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func createEraValidatorService<M1: Cuckoo.Matchable>(for p0: M1) -> Cuckoo.__DoNotUse<(SSFModels.ChainModel), EraValidatorServiceProtocol> where M1.MatchedType == SSFModels.ChainModel {
            let matchers: [Cuckoo.ParameterMatcher<(SSFModels.ChainModel)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "createEraValidatorService(for p0: SSFModels.ChainModel) throws -> EraValidatorServiceProtocol",
                callMatcher: callMatcher,
