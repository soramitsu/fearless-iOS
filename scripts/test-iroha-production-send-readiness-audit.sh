...
expect_manifest_failure "torii-root" "networkReadiness.readOnlyToriiRoot" '"https://example.invalid"' "read-only Taira Torii root drifted"
expect_manifest_failure "read-sdk-branch" "networkReadiness.readOnlySDKBranch" '"main"' "read-only SDK source branch drifted"
expect_manifest_failure "read-sdk-commit" "networkReadiness.readOnlySDKCommit" '"0000000000000000000000000000000000000000"' "read-only SDK source commit drifted"
...
expect_manifest_failure "asset-schema" "networkReadiness.liveTairaNativeXorNumericSpec" '"fixed"' "live Taira XOR NumericSpec drifted"
expect_manifest_failure "asset-scale" "networkReadiness.liveTairaNativeXorScale" '18' "canonical Taira XOR must not invent a fixed scale"
expect_manifest_failure "adapter-precision" "networkReadiness.liveTairaNativeXorWalletAdapterPrecision" '9' "Taira wallet adapter precision drifted"
...
expect_manifest_failure "alternate-asset" "networkReadiness.liveTairaAlternateXorDefinitionId" '"00000000000000000000000000000000000000000000"' "live Taira distinct XOR definition drifted"
