...
final class ArrowsquidHistoryOperationFactory {
    ...
    private func createOperation(
    ...
    ) -> BaseOperation<ArrowsquidHistoryResponse> {
        ...
        let resultFactory = AnyNetworkResultFactory<ArrowsquidHistoryResponse> { data in
            do {
    ...
    private func createSubqueryHistoryMergeOperation(
        dependingOn remoteOperation: BaseOperation<ArrowsquidHistoryResponse>?,
        localOperation: BaseOperation<[TransactionHistoryItem]>?,
        asset: AssetModel,
        chain: ChainModel,
        address: String
    ...
    private func createSubqueryHistoryMapOperation(
        dependingOn mergeOperation: BaseOperation<TransactionHistoryMergeResult>,
        remoteOperation _: BaseOperation<ArrowsquidHistoryResponse>,
...
extension ArrowsquidHistoryOperationFactory: HistoryOperationFactoryProtocol {
    func fetchTransactionHistoryOperation(
        ...
        let remoteHistoryOperation: BaseOperation<ArrowsquidHistoryResponse>
        ...
        if let baseUrl = chain.externalApi?.history?.url {
            ...
            let result = ArrowsquidHistoryResponse(historyElements: [])
