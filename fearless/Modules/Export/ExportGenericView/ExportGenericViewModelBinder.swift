...
final class ExportGenericViewModelBinder: ExportGenericViewModelBinding {
    ...
    func bind(stringViewModel: ExportStringViewModel, locale: Locale) -> UIView {
        ...
        detailsView.title = stringViewModel.option.titleForLocale(locale, ecosystem: stringViewModel.ecosystem)
    ...
    func bind(multilineViewModel: ExportStringViewModel, locale: Locale) -> UIView {
        ...
        detailsView.titleLabel.text = multilineViewModel.option.titleForLocale(locale, ecosystem: multilineViewModel.ecosystem)
