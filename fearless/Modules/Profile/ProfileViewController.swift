...
final class ProfileViewController: UIViewController, HiddableBarWhenPushed {
    ...
    private func configureTableView() {
        ...
        tableView.register(UINib(resource: R.nib.profileDetailsTableViewCell),
                           forCellReuseIdentifier: R.reuseIdentifier.profileDetailsCellId.identifier)

        tableView.register(UINib(resource: R.nib.profileSectionTableViewCell),
...
extension ProfileViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.profileSectionCellId,
                                                     for: indexPath)!
