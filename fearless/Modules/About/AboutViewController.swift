...
final class AboutViewController: UIViewController, AdaptiveDesignable {
    ...
    private func prepareTitleCell(
        for tableView: UITableView,
        indexPath: IndexPath,
        title: String
    ) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(
            withIdentifier: R.reuseIdentifier.aboutTitleCellId,
            for: indexPath
        )!
    ...
    private func prepareDetailsCell(
        for tableView: UITableView,
        indexPath: IndexPath,
        title: String,
        subtitle: String,
        ...
        let cell = tableView.dequeueReusableCell(
            withIdentifier: R.reuseIdentifier.aboutDetailsCellId,
            for: indexPath
        )!
...
extension AboutViewController: UITableViewDelegate {
    ...
    func tableView(_: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        guard let view = UINib(resource: R.nib.aboutHeaderView)
            .instantiate(withOwner: nil, options: nil).first as? AboutHeaderView
        else {
            return nil
        }
