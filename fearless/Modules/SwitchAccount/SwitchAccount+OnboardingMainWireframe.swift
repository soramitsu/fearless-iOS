...
extension SwitchAccount {
    final class OnboardingMainWireframe: OnboardingMainWireframeProtocol {
        func didCompleteCreate(from _: ControllerBackedProtocol?) {}
        ...
        func showAccountRestore(defaultSource _: AccountImportSource, flow _: AccountImportFlow, from view: OnboardingMainViewProtocol?) {
