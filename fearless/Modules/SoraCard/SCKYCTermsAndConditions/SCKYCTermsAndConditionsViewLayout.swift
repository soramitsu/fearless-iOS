...
final class SCKYCTermsAndConditionsViewLayout: UIView {
    ...
    let generalTermsButton = SCKYCTermsConditionsButton()
    let privacyButton = SCKYCTermsConditionsButton()
...
private extension SCKYCTermsAndConditionsViewLayout {
    func setupLayout() {
