...
final class StakingRedeemPoolStrategy: RuntimeConstantFetching, AccountFetching {
    weak var output: StakingRedeemPoolStrategyOutput?
    ...
    init(
        output: StakingRedeemPoolStrategyOutput?,
...
extension StakingRedeemPoolStrategy: StakingRedeemStrategy {
    func setup() {
...
extension StakingRedeemPoolStrategy: AccountInfoSubscriptionAdapterHandler {
    func handleAccountInfo(result: Result<AccountInfo?, Error>, accountId _: AccountId, chainAsset _: ChainAsset) {
        output?.didReceiveAccountInfo(result: result)
    }
}

extension StakingRedeemPoolStrategy: AnyProviderAutoCleaning {}

extension StakingRedeemPoolStrategy: ExtrinsicFeeProxyDelegate {
    func didReceiveFee(result: Result<RuntimeDispatchInfo, Error>, for _: ExtrinsicFeeId) {
        output?.didReceiveFee(result: result)
    }
}

extension StakingRedeemPoolStrategy: RelaychainStakingLocalStorageSubscriber, RelaychainStakingLocalSubscriptionHandler {
