...
final class StakingRedeemConfirmationParachainStrategy: RuntimeConstantFetching, AccountFetching {
    weak var output: StakingRedeemConfirmationParachainStrategyOutput?
    ...
    init(
        output: StakingRedeemConfirmationParachainStrategyOutput?,
...
extension StakingRedeemConfirmationParachainStrategy: StakingRedeemConfirmationStrategy {
    func setup() {
...
extension StakingRedeemConfirmationParachainStrategy: AccountInfoSubscriptionAdapterHandler {
    func handleAccountInfo(result: Result<AccountInfo?, Error>, accountId _: AccountId, chainAsset _: ChainAsset) {
        output?.didReceiveAccountInfo(result: result)
    }
}

extension StakingRedeemConfirmationParachainStrategy: AnyProviderAutoCleaning {}

extension StakingRedeemConfirmationParachainStrategy: ExtrinsicFeeProxyDelegate {
