...
final class StakingRedeemConfirmationRelaychainStrategy: RuntimeConstantFetching, AccountFetching {
    weak var output: StakingRedeemConfirmationRelaychainStrategyOutput?
    ...
    init(
        output: StakingRedeemConfirmationRelaychainStrategyOutput?,
...
extension StakingRedeemConfirmationRelaychainStrategy: StakingRedeemConfirmationStrategy {
    func setup() {
...
extension StakingRedeemConfirmationRelaychainStrategy: AccountInfoSubscriptionAdapterHandler {
    func handleAccountInfo(result: Result<AccountInfo?, Error>, accountId _: AccountId, chainAsset _: ChainAsset) {
        output?.didReceiveAccountInfo(result: result)
    }
}

extension StakingRedeemConfirmationRelaychainStrategy: RelaychainStakingLocalStorageSubscriber, RelaychainStakingLocalSubscriptionHandler {
...
extension StakingRedeemConfirmationRelaychainStrategy: AnyProviderAutoCleaning {}

extension StakingRedeemConfirmationRelaychainStrategy: ExtrinsicFeeProxyDelegate {
