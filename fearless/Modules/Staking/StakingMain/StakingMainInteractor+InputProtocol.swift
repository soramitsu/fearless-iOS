...
extension StakingMainInteractor: StakingMainInteractorInputProtocol {
    ...
    func fetchCollatorsDelegations(accountIds: [AccountId]) {
        ...
        operationManager.enqueue(operations: delegationScheduledRequests.allOperations + bottomDelegationsOperation.allOperations + topDelegationsOperation, in: .transient)
    }
