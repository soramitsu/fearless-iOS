...
extension ImageViewModelProtocol {
    ...
    func loadAmountInputIcon(on imageView: UIImageView, animated: Bool, cornerRadius: CGFloat) {
        loadImage(on: imageView, targetSize: CGSize(width: 24.0, height: 24.0), animated: animated, cornerRadius: cornerRadius)
    }
    ...
    func loadBalanceListIcon(on imageView: UIImageView, animated: Bool, cornerRadius: CGFloat) {
        loadImage(on: imageView, targetSize: CGSize(width: 48.0, height: 48.0), animated: animated, cornerRadius: cornerRadius)
    }
}
