...
extension RecommendedValidatorListPoolViewModelFactory: RecommendedValidatorListViewModelFactoryProtocol {
    func buildViewModel(viewModelState: RecommendedValidatorListViewModelState, locale: Locale) -> RecommendedValidatorListViewModel? {
        guard let relaychainViewModelState = viewModelState as? RecommendedValidatorListPoolViewModelState else {
            return nil
        }
