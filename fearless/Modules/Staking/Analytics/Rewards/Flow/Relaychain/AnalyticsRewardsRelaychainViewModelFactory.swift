...
final class AnalyticsRewardsRelaychainViewModelFactory: AnalyticsViewModelFactoryBase<SubqueryRewardItemData>,
    ...
    func createViewModel(
        ...
        guard let relaychainViewModelState = viewModelState as? AnalyticsRewardsRelaychainViewModelState,
              let subqueryData = relaychainViewModelState.subqueryData else {
            return nil
        }
