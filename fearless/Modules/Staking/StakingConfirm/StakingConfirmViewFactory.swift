...
final class StakingConfirmViewFactory: StakingConfirmViewFactoryProtocol {
    ...
    -> StakingConfirmViewProtocol? {
        ...
        guard let interactor = createChangeTargetsInteractor(state,
                                                             connection: connection,
                                                             keystore: keystore,
                                                             assetId: assetId,
                                                             networkSettings: networkSettnigs) else {
            return nil
        }
    ...
    static private func createView(for interactor: StakingBaseConfirmInteractor,
                                   settings: SettingsManagerProtocol,
                                   keystore: KeystoreProtocol) -> StakingConfirmViewProtocol? {
    ...
    static private func createInitiatedBondingInteractor(_ nomination: PreparedNomination<InitiatedBonding>,
    ...
    static private func createChangeTargetsInteractor(_ nomination: PreparedNomination<ExistingBonding>,
                                                      connection: JSONRPCEngine,
                                                      keystore: KeystoreProtocol,
    ...
    -> ChangeTargetsConfirmInteractor? {
        ...
        let extrinsicService = ExtrinsicService(address: extrinsicSender.address,
        ...
        return ChangeTargetsConfirmInteractor(priceProvider: priceProvider,
